    ...
    return SizedBox(
        ...
        return DropdownMenuItem<String>(
          ...
          child: Container(
              ...
              child: Text(value, style: TextStyle(color: Colors.white,fontSize: 18.0, fontFamily: 'CenturyGothic'),textAlign: TextAlign.center, ),
  ...
  Widget build(BuildContext context) {
    ...
    child: Center(
      child: Container(
          ...
          child: Text(value, style: TextStyle(color: Colors.white,fontSize: 17.0, fontFamily: 'CenturyGothic'),textAlign: TextAlign.center, ),
          color:Color.fromRGBO(255, 114,0, 0.9),
          ),
    ) ,
...
class DropDownZonaSocialAdmin extends StatefulWidget {
  ...
  @override
  _DropDownZonaSocialAdminState createState() => _DropDownZonaSocialAdminState();
}
            ...
            items : <String>['Activo','Inactivo']
                .map<DropdownMenuItem<String>> ((String value){
                  ...
                  return DropdownMenuItem<String>(
                    ...
                    value: value,
                    child: Text(value, style:TextStyle(fontSize:16.0,fontFamily:'CenturyGothic', color: Colors.grey.shade600, fontWeight: FontWeight.bold),) ,
...
class DropDownLugarReservaWidget extends StatefulWidget {
  ...
  @override
  _DropDownLugarReservaWidgetState createState() => _DropDownLugarReservaWidgetState();
}

String dropdownStrLugar = 'ZONA SOCIAL';

class _DropDownLugarReservaWidgetState extends State<DropDownLugarReservaWidget> {
  @override
  Widget build(BuildContext context) {
     return Container(
       child: Center(
         child: DropdownButtonHideUnderline(
             ...
             onChanged: (String newValue){
               ...
               items : <String>['ZONA SOCIAL','Piscina','Salon social','Gimnasio','Otro']
                  .map<DropdownMenuItem<String>> ((String value){
                    
                    return DropdownMenuItem<String>(
                      
                      value: value,
                      child: Text(value, style: TextStyle(color:Colors.grey, fontFamily:'CenturyGothic', fontWeight:FontWeight.bold),) ,
...
class DropdownWidgetEmergencia extends StatefulWidget {
 DropdownWidgetEmergencia({Key key}) : super(key: key);
  ...
  @override
  _DropdownWidgetEmergenciaState createState() => _DropdownWidgetEmergenciaState();
}
    ...
    return SizedBox(
          ...
          isDense: true,
              ...
              onChanged: (String newValue){
                ...
                items : <String>['Incendio','Inundación','Emergencia familiar','Fuga de gas','Robo','Otro']
                   .map<DropdownMenuItem<String>> ((String value){
        ...
        return DropdownMenuItem<String>(
          ...
          child: Container(
              ...
              child: Text(value, style: TextStyle(fontSize: 16.0, fontFamily: 'CenturyGothic'),textAlign: TextAlign.center, ),
