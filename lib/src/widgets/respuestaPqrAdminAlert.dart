...
responderPqrAdmin(BuildContext context,destinatario,tipo,id,estado) {
                      ...
                      GestureDetector(
                        onTap: () {
                          ...
                          if (observaciones.text.isEmpty) {
                            ...
                            pqrRespuestaProvider.respuestaAdmin(observaciones.text, appData.idUsuario, id, _image, appData.nombre,context).then((val){
