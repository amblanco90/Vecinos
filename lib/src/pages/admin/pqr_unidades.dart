...
class PqrUnidades extends StatefulWidget {

 
  @override
  _PqrUnidadesState createState() => _PqrUnidadesState();
}

class _PqrUnidadesState extends State<PqrUnidades> {
  ...
  Widget cardMensajes(
    ...
    return GestureDetector(
        onTap: () {
          estadoPqrAdmin(context,texto,foto,estadoString,id,destinatario,tipo);
        },
        child: Card(
          color: color,
          child: Container(
