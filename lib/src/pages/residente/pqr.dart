           ...
           child: Container(
             ...
             child: Column(
               ...
               children: <Widget>[
                 ...
                 snapshot.data[index].estado==0?Text('CANCELADO', maxLines: 3,
                 style: TextStyle(color: Colors.grey.shade600,fontWeight: FontWeight.bold, fontFamily: 'CenturyGothic'),):Container(),
                 snapshot.data[index].estado==1?Text('PENDIENTE', maxLines: 3,
                 style: TextStyle(color: Colors.grey.shade600,fontWeight: FontWeight.bold, fontFamily: 'CenturyGothic'),):Container(),
                 snapshot.data[index].estado==2?Text('ATENDIDO', maxLines: 3,
                 style: TextStyle(color: Colors.grey.shade600,fontWeight: FontWeight.bold, fontFamily: 'CenturyGothic'),):Container(),
               ],
             ),
           ),
