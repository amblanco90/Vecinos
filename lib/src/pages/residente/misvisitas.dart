...
>>>>>>> 4663e53763ecaf25f417c346167cf31c290d0434
        ...
        children: <Widget>[
          Column(
            children: <Widget>[
              ...
              _camposFormulario('IDENTIFICACION', _identificacionController,
                  TextInputType.number),
              _camposFormulario(
                  'NOMBRE VISITANTE', _nombreController, TextInputType.text),
              _camposFormulario('NUMERO DE CONTACTO', _numeroContantoController,
                  TextInputType.number),
                ...
                child: Container(
                    ...
                    child: Row(children: <Widget>[
                      ...
                      Text(
                        ...
                        style: TextStyle(
                            fontSize: 13.0,
                            color: Color.fromRGBO(189, 186, 186, 1),
                            fontFamily: 'CenturyGothic',
                            fontWeight: FontWeight.bold),
                      ),
                      Container(
                              ...
                              if (_nombreController.text.length > 1) {
                                if (_identificacionController.text.length < 6) {
                                  ...
                                  _alertVisitaMensajes(context,
                                      "Su numero de identificacion debe ser mayor a 5 digitos y menor a 10");
                                  return;
                                }
                                if (_validarnumeros(
                                        _identificacionController.text) ==
                                ...
                                DatosVisitas datosVisitas = DatosVisitas(
                                    id_visitante: "",
                                    id_residente: appData.idUsuario.toString(),
                                    cedula_visitante:
                                        _identificacionController.text,
                                    nombre_visita: _nombreController.text,
                                    placa_auto: "agc-654",
                                    fecha_visita: _selectedDate,
                                    observaciones:
                                        _observacionvisitaController.text,
                                    username: "prueba",
                                    estado: "1",
                                    foto: base64Image.toString());
                                ApiService _apiService = new ApiService();
                                _apiService
                                    .createProfile(datosVisitas)
                                    .then((isSuccess) {
                                  _estadolistareserva = true;
                                  if (isSuccess) {
                                    pr.hide();
                                    ...
                                    pr.hide();
                                    _alertVisitaMensajes(context,
                                        "Asegúrese se introducir una identificación valida.");
                                  }
                                });
                              } else {
                                pr.hide();
                                _alertVisitaMensajes(
                                    context, "No se puede dejar campos vacios");
                              }
                              pr.hide();
                            },
              ...
              Padding(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                      color: Color.fromRGBO(203, 197, 197, 1),
  ...
  _tablaVisita(BuildContext context) {
    if (_estadolistareserva == true) {
      return FutureBuilder(
          future: _solicitarVisitas.getlistavisitas(),
  ...
  _capturePng() async {
    ...
    try {
     ...
     Share.file("Codigo qr", "qr.png", pngBytes, "image/png");
      ...
      _alertVisitaMensajes(context, e.toString());
=======
...
>>>>>>> 4663e53763ecaf25f417c346167cf31c290d0434
    ...
    /*try {
      ...
      pr.hide();
      ui.Image image = await boundary.toImage().then((value) async {
        ByteData byteData =
